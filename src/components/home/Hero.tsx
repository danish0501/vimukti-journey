...
import heroImage from "@/assets/offering-2.jpg";
                ...
                <div className="space-y-8 animate-fade-in-up">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4 pt-8 animate-fade-in-up" style={{ animationDelay: '700ms' }}>
                        <Link to="/contact" className="w-full sm:w-auto">
                            <Button size="xl" className="w-full bg-[#32774D] text-white hover:text-white transition-all duration-300 text-lg h-14 shadow-lg hover:shadow-xl hover:-translate-y-1">
                                Start Your Journey
                            </Button>
                        </Link>
                        <Link to="/services" className="w-full sm:w-auto">
                            <Button variant="outline" size="xl" className="w-full bg-transparent text-white border-white hover:bg-[#32774D] hover:border-[#32774D] hover:text-white transition-all duration-300 text-lg h-14 backdrop-blur-sm shadow-lg hover:shadow-xl hover:-translate-y-1">
                                Explore Services
                            </Button>
                        </Link>
                    </div>
